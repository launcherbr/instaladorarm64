...
```bash
sudo apt install -y git && git clone https://github.com/launcherbr/novoinstalador.git instalador && sudo chmod -R 777 instalador  && cd instalador  && sudo ./install_primaria
```
